...
%\documentclass[12pt,a4paper]{report}      %% LaTeX2e document.
\documentclass[12pt,a4paper,twoside, openright]{report}      %% LaTeX2e document.
...
\begin{thesisabbreviations}       %! Use this to give a list of
	...
	\begin{itemize}
		...
		\item[ADU]Analogue Digital Unit. The value returned for each pixel from the CCD chip after a readout. This is a measure of the flux arriving at the pixel.  
	\end{itemize}
                                   %! abbreviateons
                                   %! It can be anything
...
\chapter{Automating the reduction pipeline}\label{chap:datareduction}
\input datareduction.tex

\chapter{Creating a web enabled light-curve browser}\label{chap:webfrontend}
\input webfrontend.tex

\chapter{Results from the automated pipeline}\label{chap:results}
\input results.tex
