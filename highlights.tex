...
This object is another suspected {W UMa} variable found in the same field as the previous object. The light-curve for this object, figure \ref{fig:2013-07-21-run010-163} and \ref{fig:2013-07-21-run010-163-colour}, includes one minimum and one maximum, although not a full orbit. From this light-curve, the estimated period is about 460 minutes or 0.32 days.
...
This object was found on a run that included the exoplanet host, KIC 5115978, which has at least one planet, \citep{KIC5115978}. The new variable is located about 6 arc minutes away from the target. A search of the Kepler data archive \footnote{\url{http://archive.stsci.edu/kepler/kepler_fov/search.php}} gives no results for this object. Unfortunately. although this object is in the Kepler field of view, it lies in a position that does not fall on a Kepler CCD. We have therefore have no further photometry for this object. 
...
\begin{equation}D = \frac{1130}{\sqrt{p}}10^{-H/5}.\end{equation}
