...
The web-enabled light-curve browser allowed us to quickly inspect the light-curves of many thousands of objects in the ULTRACAM archive so far. Although a systematic approach has not yet been taken to examine the whole archive, our ad-hoc reviews of the data have already revealed some interesting new variable objects. a few of these are highlighted in this chapter. 
...
This object is another suspected {W Uma} variable found on the same field as the previous object. The light-curve for this object includes one minimum and one maximum, although not a full orbit. From this light-curve, the estimated period is about 460 minutes or 0.32 days.
...
The light-curve of this object appears to include an eclipse. Since the eclipse has totality as indicated by the flat-bottom and the drop in flux is about 50\% it is most likely that this is the primary eclipse. Since there is a totality to this eclipse it indicates that the primary has a smaller diameter than the secondary. The primary eclipse duration is 37 minutes with a drop in flux of about 0.7 magnitudes. 
...
There is evidence that the colour is varying in phase with magnitude, most noticeably in $(g - i)$, see figure \ref{fig:2013-07-21-run010-23-colour}. The period is approximately 0.04 days, consistent with the expected range 0.03-0.3 days and the amplitude is of the pulsation in Sloan g is about 0.02 magnitudes.
