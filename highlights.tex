...
\begin{table}
  ...
  \hline
    ...
    {W Uma} & 2013-07-21-run010-48 & 19:44:09.8, 40:16:34.4\\
    {W Uma} & 2013-07-21-run010-163 & 19:44:10.3, 40:18:08.1\\
    Eclipsing binary & 2013-07-21-run011-162 & 19:54:01.7, 40:37:34\\
    $\delta$ Scuti & 2013-07-21-run010-23 & 19:44:19.6, 40:16:43.7\\
  \hline
    \parbox[c]{5cm}{Asteroid\\ } & \parbox[c]{5cm}{2011-08-26-run014-110\\ 1998 SU139\\ } & \parbox[c]{5cm}{20:51:12, -08:31:25\\ at MJD=55800.038}\\
    \parbox[c]{5cm}{Asteroid\\ } & \parbox[c]{5cm}{2009-01-04-run024-61\\9108 Toruyusa (1997 AZ6)\\}& \parbox[c]{5cm}{08:04:52.3, +16:18:10.6\\at  MJD=54836.26642}\\
...
\begin{table}
  ...
  \parbox{4.5cm}{
   ...
   \parbox{4.5cm}{
     \center
      \includegraphics[width=40mm]{images/2013-07-21-run010-48.png} \\
    2013-07-21-run010-48
   }
   &
   \parbox{4.5cm}{
     \center
     \includegraphics[width=40mm]{images/2013-07-21-run010-163.png} \\
     2013-07-21-run010-163
   } 
   \\
   \parbox{4.5cm}{
     \center
     \includegraphics[width=40mm]{images/2013-07-21-run011-162.png} \\
     2013-07-21-run011-162
     }
   &  
   \parbox{4.5cm}{
     \center
     \includegraphics[width=40mm]{images/2013-07-21-run010-23.png} \\
     2013-07-21-run010-23
   }
   &
   \\
  \end{tabular}
  \caption{Finding charts for the objects listed in table \ref{tab:newobjects}, excluding the asteroids.}
