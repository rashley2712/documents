...
\end{array}  
$
This filter is normalised before being applied to the image.ß
...
\begin{figure}
  \centering
  \includegraphics[width=100mm]{images/objectOffset_run010_g.eps}
  \includegraphics[width=100mm]{images/objectOffset_run010_b.eps}
  \caption{The difference in object mean positions between the `red' channel and the `green' channel (upper image) and the `red' channel and `blue' channel lower image), for run: \emph{2013-07-21/run010} }
