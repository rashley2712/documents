...
\begin{center}
	\begin{tabular}{|l|r|r|r|}
		...
		\hline
		WHT & 7x7 &  0.40 & N(up), E(left)\\
		NTT & 8x8 & 0.40 & N(up), W(left)\\
		VLT & 6x6 & 0.40 & N(up), E(left) \\
		\hline
	\end{tabular}
\end{center}
